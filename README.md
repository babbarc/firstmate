...
- [docs/gitea-merge-watch.md](docs/gitea-merge-watch.md) - maintainer verification for watching and merging Gitea pull requests on allow-listed self-hosted instances.
